        ...
        <>
            <div className={style.mainContainer}>
                ...
                <div className={style.mainContainer_design}>
                    ...
                    <TeamCard name="shradha gurjar" image={"/images/team/13123123.jpeg"} position={"I'vent'O Non tech head"} facebook={""} instagram={"https://instagram.com/Shra_ddha203"}  twitter={""} linkedIn={"https://www.linkedin.com/in/shradha-gurjar-976b05247"}   github={"https://github.com/shradhagurjar27"} youtube={""}/>
                    <TeamCard name="Devansh Kulshrestha" image={"/images/team/123232312.jpg"} position={"I'vent'O eSports head"} facebook={"https://www.facebook.com/devansh.kulshrestha.562"} instagram={"https://instagram.com/___mr.__kd"}  twitter={""} linkedIn={"https://www.linkedin.com/in/devansh-kulshrestha-151098228/"} github={""}  youtube={""}/>
                    <TeamCard name="chetan sharma" image={"/images/team/chetanww.jpg"} position={"I'vent'O management head"} facebook={"https://www.facebook.com/people/Adarsh-Dubey/100029093229302/"}instagram={"https://www.instagram.com/_.isshh_parsh/"}  twitter={"https://twitter.com/kakashi3007?t=Rb3FSsCgTNk6Twx_Dlw7SA&s=09"} linkedIn={""}   github={""}  youtube={""}/>
                    <TeamCard name="Dhwaj sharma" image={""} position={"I'vent'O co-head"} facebook={""}instagram={"https://www.instagram.com/_sweet_evil_devil_god_/"}  twitter={""} linkedIn={""} github={""}  youtube={""}/>
                    <TeamCard name="Shreshtha kinger" image={"/images/team/123123123.jpeg"} position={"I'vent'O Non tech co-head"} facebook={""}instagram={"https://instagram.com/shreshthakinger"}  twitter={""} linkedIn={"https://www.linkedin.com/in/shreshtha-kinger-57a13824b"}   github={""}  youtube={""}/>
